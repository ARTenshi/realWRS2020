...
LOCATIONS = {'desk': ((2.722, -0.311), -1.6), 
             ...
             'corridor': ((5.1, 1.7), 0), 
             'entrance': ((2.0, 0.0), 0), 
             'living room': ((10.85, 4.8), 1.66), 
             'cupboard': ((1.13, 5.52), 1.57), 
             'sofa': ((1.131, -1.475), -0.691), 
             'kitchen counter': ((6.25, 0.34), -2.39), 
             'fridge': ((7.05, -1.04), -2.27), 
             'bookcase': ((-6.528, 10.507), -2.921), 
             'coffee table': ((10.7, 4.78), 2.3), 
             'bistro table': ((8.09, 6.56), -2.97), 
             'right planks': ((5.99, 6.02), 3.08), 
             'kitchen': ((7.38, 1.49), 0), 
             'entrance shelf': ((2.3, 1.0), 0.0), 
             'teepee': ((-0.039, -0.088), -0.076), 
             'dining table': ((-4.421, 9.524), -1.502), 
             'kitchen table': ((0.70, 4.54), -0.03), 
             'bed': ((-0.037, -0.087), -0.076), 
             'kitchen shelf': ((0.83, 4.408), -0.066), 
